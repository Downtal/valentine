    ...
    <div className="relative w-full max-w-2xl animate-scale-in bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row h-auto md:h-[650px]">
      ...
      <div className="hidden md:flex md:w-1/3 bg-soft-pink items-center justify-center relative p-8">
        ...
        <div className="relative z-10 text-center space-y-4">
          ...
          <h3 className="font-bold text-2xl text-gray-800">Thư tình gửi em</h3>
      ...
      <div className="flex-1 paper-texture relative flex flex-col overflow-hidden">
        ...
        <div className="absolute top-8 right-8 rotate-12 opacity-80 hidden sm:block">
          <div className="border-4 border-double border-primary/20 p-2 rounded-lg w-24 h-28 bg-white shadow-md flex flex-col items-center justify-center">
            ...
            <span className="text-[10px] text-gray-400 font-bold mt-1">2024</span>
          </div>
        </div>
        ...
        <div className="flex-1 p-8 md:p-14 overflow-y-auto no-scrollbar">
          <div className="max-w-md mx-auto space-y-8">
            <h1 className="font-handwriting text-4xl text-gray-800">Gửi người thương...</h1>
            <div className="font-handwriting text-2xl text-gray-700 space-y-8 leading-relaxed">
              <p>
                Em à, Valentine này anh chỉ muốn nói rằng cảm ơn em vì đã đến bên anh. Mỗi ngày trôi qua đều là một ngày hạnh phúc khi có em ở bên.
              </p>
              <p>
                Anh nhớ nụ cười của em, nhớ cách em nhíu mày khi tập trung, và cả những lúc em giận dỗi vu vơ. Tất cả những điều nhỏ bé ấy làm nên thế giới của anh.
              </p>
              <p>
                Mong rằng chúng ta sẽ còn đón thêm nhiều mùa Valentine nữa cùng nhau. Yêu em nhiều hơn những gì lời nói có thể diễn tả.
              </p>
            </div>
            <div className="text-right pt-8">
              <p className="font-handwriting text-2xl text-gray-600">Mãi yêu em,</p>
              <p className="font-handwriting text-4xl font-black text-primary mt-2">Anh</p>
            </div>
          </div>
        </div>

        {/* Footer */}
        <div className="p-6 border-t border-gray-100 bg-white/50 backdrop-blur-sm flex justify-center">
          <button 
            onClick={onClose}
            className="flex items-center gap-2 bg-primary hover:bg-red-600 text-white px-10 py-4 rounded-full shadow-lg shadow-primary/20 transition-all transform hover:-translate-y-1 active:scale-95"
          >
            <span className="material-symbols-outlined">close</span>
            <span className="font-bold uppercase tracking-widest text-sm">Đóng thư</span>
          </button>
        </div>
      </div>
    </div>
